...
const Top: ((props?: any) => JSX.Element) = () => {
    ...
    return (
        <div id={styles.top} className='nes-container is-dark'>
            ...
            <div id={styles.about}>{bottomText}</div>
